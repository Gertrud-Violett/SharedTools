...
def WTcalc(type,C_Dm):
    ...
    if type=="op":
        ...
        tau = -0.32/(1-M**2)**1.5*(2*H/W+W/2/H)**0.252
        #tau=-0.26
    ...
    #closed
        ...
        print("input error (open/close)")




WTcalc("op",0.341) #mode(op or cl), input raw Cd value
